...
import 'models/catogaris.dart';

// ignore: unnecessary_const, non_constant_identifier_names
List<Catogaris> Categories_data = const [
  Catogaris(
    id: 'c1',
    title: 'Mosques',
    imageUrl:
        'https://images.unsplash.com/photo-1636112041884-9cedf1bd3e29?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fEFyYWIlMjBoZXJpdGFnZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60',
  ),
  Catogaris(
    id: 'c2',
    title: 'Lakes',
  ...
  Catogaris(
      ...
      title: 'Arab heritage',
      imageUrl:
          'https://images.unsplash.com/photo-1656383986839-4dd18e780c6c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8QXJhYiUyMGhlcml0YWdlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60'),
  Catogaris(
    id: 'c8',
    title: 'Other',
    imageUrl:
...
List<Trip> Trips_data = const [
  Trip(
    ...
    program: [
      'Aliate, set du osmod tempor ancaidediontiot laboure at dollar magna aliquia.',
      'Aliate, set du osmod tempor ancaidediontiot laboure at dollar magna aliquia.',
      'Aliate, set du osmod tempor ancaidediontiot laboure at dollar magna aliquia.',
      'Aliate, set du osmod tempor ancaidediontiot laboure at dollar magna aliquia.',
      'Aliate, set du osmod tempor ancaidediontiot laboure at dollar magna aliquia.',
